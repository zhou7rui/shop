  ...
  <body>
    <div class="wrapper">
     ...
     <div class="reg">
	   ...
	   <fieldset id="fie-1">
		<span>手机:</span><input type="text" name="phone" placeholder="手机" id="phone" />
		<input type="button" name="next" class="send action-button" value="获取验证码"> 
		<p style="display: none">
		<span>验证码:</span><input type="text" name="code"  placeholder="输入手机收的验证码" id="code" />
		</p>
		<input type="button"  class="next action-button" id="next-1" value="下一步" />
	   </fieldset>
	   <fieldset id="fie-2">
